...
export function sessionDescriptionHandlerFactory(session:any, options:any) {
  ...
  (sdh as any).on('addTrack', async (track:any, stream:any) => {
    ...
    try {
      ...
      // SLEG - Test
      // await session.__media.playGreeting();
    } catch (e) {
